;;; bookmark-plus-gt-preview.el --- Live preview for Bookmark+ jump  -*- lexical-binding:t -*-
;;
;; Filename:    bookmark-plus-gt-preview.el
;; Description: Live preview for `bmkp-gt-jump' and `*Bookmark List*'.
;;              Part of bookmark-plus-gt, a non-invasive extension
;;              layer over Bookmark+ (`bookmark-plus').
;;
...
;;       `bmkp-gt-preview-use-consult-flag' is non-nil, the interactive
...
(defcustom bmkp-gt-preview-use-consult-flag t
...
When `consult' is loaded and `bmkp-gt-preview-use-consult-flag' is
...
Otherwise falls back to `bookmark-completing-read'."
  ...
  (setq bmkp-gt-jump--active-filters nil)
  (if (and bmkp-gt-preview-use-consult-flag
           (featurep 'consult)
...
(provide 'bookmark-plus-gt-preview)

;;; bookmark-plus-gt-preview.el ends here
