;;; bmkp-gt-test-preview.el --- Tests for bmkp-gt-list-preview-mode and consult reader   -*- lexical-binding: t -*-
;;
...
(ert-deftest bmkp-gt-test-preview/mode-defined ()
  "`bmkp-gt-list-preview-mode' is defined."
  (should (fboundp 'bmkp-gt-list-preview-mode)))

(ert-deftest bmkp-gt-test-preview/mode-toggles ()
...
(ert-deftest bmkp-gt-test-preview/lighter-present-when-active ()
...
(ert-deftest bmkp-gt-test-preview/consult-jump-reader-defined ()
  "`bmkp-gt-read-bookmark-for-jump' is defined."
  (should (fboundp 'bmkp-gt-read-bookmark-for-jump)))

(ert-deftest bmkp-gt-test-preview/preview-warn-once-per-name ()
...
(ert-deftest bmkp-gt-test-preview/consult-flag-default ()
  "`bmkp-gt-preview-use-consult-flag' is t by default."
  (should (boundp 'bmkp-gt-preview-use-consult-flag))
  (should bmkp-gt-preview-use-consult-flag))
...
(ert-deftest bmkp-gt-test-preview/location-default-returns-url-for-url-bookmark ()
...
(ert-deftest bmkp-gt-test-preview/location-default-nil-for-file-bookmark ()
...
(ert-deftest bmkp-gt-test-preview/annotation-substitutes-url-for-no-file-marker ()
...
(ert-deftest bmkp-gt-test-preview/annotation-honors-user-override ()
...
(ert-deftest bmkp-gt-test-preview/annotation-rewrites-marginalia-type-column ()
...
(ert-deftest bmkp-gt-test-preview/annotation-leaves-type-column-alone-when-unknown ()
...
(ert-deftest bmkp-gt-test-preview/annotation-leaves-file-bookmark-alone ()
...
(ert-deftest bmkp-gt-test-preview/candidate-default-name-and-properties ()
...
(ert-deftest bmkp-gt-test-preview/candidate-default-appends-hidden-type-name ()
...
(ert-deftest bmkp-gt-test-preview/candidate-type-name-lookup ()
...
(ert-deftest bmkp-gt-test-preview/candidate-default-appends-hidden-tags ()
...
(ert-deftest bmkp-gt-test-preview/candidate-format-honors-user-override ()
...
(ert-deftest bmkp-gt-test-preview/candidate-format-falls-back-when-non-function ()
